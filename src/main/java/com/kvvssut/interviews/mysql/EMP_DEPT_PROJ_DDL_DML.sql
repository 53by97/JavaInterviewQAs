...
drop table employee cascade constraints;  -- drops all referential integrity constraints of child tables that refers to primary and unique keys in the dropped table 
